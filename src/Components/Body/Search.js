        ...
        <div className='my-4 searchParentDiv'>
            ...
            <Row className='mx-auto'>
                <Form onSubmit={handleSubmitForm} className='formAddItem'>
                    ...
                    <Form.Control autoFocus type="text" placeholder="add item here..." id='addItem' value={newItem} onChange={(e) => setnewItem(e.target.value)} ref={inputRef} />

                    <Button type="submit" onClick={() => { inputRef.current.focus() }} variant="outline-success" className='button'>+</Button>
                </Form>
